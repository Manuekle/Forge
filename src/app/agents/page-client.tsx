      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="mx-auto max-w-[1200px]">
          ...
          <motion.div
            ...
            className="relative mt-8 overflow-hidden rounded-[var(--radius-card)] bg-surface-2 p-6 ring-hair lift-2"
          >
            <div className="pointer-events-none absolute -right-10 -top-16 h-48 w-48 rounded-full opacity-30 blur-3xl aurora" />
      ...
      <AnimatePresence>
        {selected && (
          <Modal open={!!selected} onOpenChange={() => setSelected(null)}>
            ...
            <p className="mb-5 text-sm leading-relaxed text-text-secondary">{selected.agent.description}</p>
