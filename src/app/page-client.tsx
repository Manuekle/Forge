              ...
              <div className="relative flex items-center justify-center py-8">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
                  {agents.map((a, idx) => (
                    ...
                    >
                      <div className="relative flex h-14 w-14 cursor-default items-center justify-center rounded-full text-white sm:h-16 sm:w-16"
              ...
              {agents.map((a) => (
                <motion.div key={a.role} variants={fadeUp} whileHover={{ y: -4 }} className="group rounded-[var(--radius-card)] bg-surface-2 p-6 ring-hair lift-1 transition-all duration-300 hover:lift-2">
                  <div className="mb-3 flex items-center gap-4">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full text-white transition-transform duration-300 group-hover:scale-105"
                      style={{ background: a.color }}>
